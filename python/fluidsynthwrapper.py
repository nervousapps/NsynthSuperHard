    ...
    async def start(self):
        ...
        try:
            with self.client:
                ...
                while not self.client.get_all_connections(self.client.get_ports(is_midi=True, name_pattern='FLUID Synth', is_output=True)[0]):
                    print(self.client.get_all_connections(self.client.get_ports(is_midi=True, name_pattern='FLUID Synth', is_output=True)[0]))
                    try:
